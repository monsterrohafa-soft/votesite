...
const candidateData = {
  ...
  jsh: {
    pledges: [
      { icon: 'fas fa-hand-holding-heart', title: '복지 · 돌봄', desc: '세대 간 소외 없는 복지 네트워크를 만들겠습니다', details: ['바르셀로나식 공공 돌봄 모델 도입', '세대 간 소외 없는 복지 네트워크 구축', '어르신·장애인 맞춤형 돌봄 강화', '아이 키우기 좋은 보육 환경 조성'] },
      { icon: 'fas fa-store', title: '경제 · 상생', desc: '소상공인과 함께 성장하는 동래 경제를 만들겠습니다', details: ['동래역 문화 복합 스테이션 조성', '미남역 청년 창업의 메카 조성', '소상공인 상생 경제 기반 마련', '전통시장 활성화 및 지원 확대'] },
      { icon: 'fas fa-laptop-code', title: '미래 · 디지털', desc: '디지털 전환에 앞선 미래 준비 도시를 만들겠습니다', details: ['디지털 전환 선도 도시 조성', '스마트 행정 서비스 도입', '데이터 기반 도시 문제 해결', '미래형 인프라 구축'] },
      { icon: 'fas fa-graduation-cap', title: '교육 · 문화', desc: '글로벌 교육과 문화가 살아 숨쉬는 동래', details: ['글로벌 리더십 캠프 운영', '평생교육 인프라 확충', '동래 역사·문화 자원 활성화', '청소년 활동 지원 강화'] },
...
const allIntro = {
  ...
  jsh: { subtitle: '동래구의회 의장 출신, 동래의 자존심', text: '동래구의회 의장으로서 쌓은 행정 경험을 바탕으로\n동래를 세계적 혁신 도시로 도약시키겠습니다.\n소통과 혁신으로 동래의 자존심을 세우겠습니다.' },
};
...
const allCareer = {
  ...
  jsh: [
    { title: '제7대 동래구의회 의원 (비례대표)' },
    { title: '제8대 동래구의회 의원 (가선거구)' },
    { title: '제8대 동래구의회 전반기 의장' },
    { title: '더불어민주당 동래구청장 예비후보', isCurrent: true },
  ],
};
