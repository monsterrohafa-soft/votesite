...
const candidateData = {
  ...
  kma: {
    pledges: [
      { icon: 'fas fa-chart-line', title: '학력 향상', desc: '맞춤형 학력 성장으로 세종 학생의 경쟁력을 높이겠습니다', details: ['세종형 학습지원 시스템 구축', '세종학습회복센터 설치·운영', '기초학력 보장 프로그램 강화', '성적보다 지속하는 힘을 키우는 교육'] },
      { icon: 'fas fa-robot', title: 'AI·디지털 교육', desc: 'AI 시대를 선도하는 세종형 미래교육을 실현하겠습니다', details: ['세종형 AI센터 설립', 'AI·디지털 특화 고등학교 운영', 'AI 기반 개인맞춤 학습 분석 시스템', '모든 학생 디지털·AI 기초소양 교육'] },
      { icon: 'fas fa-university', title: '입시에 강한 세종교육', desc: '학부모가 신뢰하는 공교육, 사교육비 부담을 줄이겠습니다', details: ['200억 글로벌 프로젝트 추진', '영재교육 프로그램 확대', '진로·진학 컨설팅 강화', '체육바우처 지원 확대'] },
      { icon: 'fas fa-chalkboard-teacher', title: '교사 전문성 강화', desc: '교사가 존중받고 성장하는 학교 문화를 만들겠습니다', details: ['교사 전문성 신장 프로그램', '교권 보호 및 교사 존중 문화 조성', '행정 업무 경감으로 수업 집중', '현장 중심 교원 연수 체계 혁신'] },
      { icon: 'fas fa-shield-alt', title: '안전한 학교', desc: '학교폭력 없는, 안심하고 보낼 수 있는 학교를 만들겠습니다', details: ['학교폭력 예방 시스템 강화', '학생 심리상담 인프라 확충', '안전한 통학 환경 조성', '돌봄교실 확대 및 내실화'] },
    ],
    contacts: [
      { type: 'address', label: '출마 지역', value: '세종특별자치시 교육감' },
      { type: 'address', label: '소속', value: '세종미래교육연구소 대표' },
    ],
    videos: [],
  },
  ...
  jsh: {
    pledges: [
      { icon: 'fas fa-hand-holding-heart', title: '복지 · 돌봄', desc: '바르셀로나식 공공 돌봄 모델로 세대 간 복지 네트워크를 구축합니다', details: ['바르셀로나식 공공 돌봄 모델 도입', '세대 간 소외 없는 복지 네트워크 구축', '어르신·장애인 맞춤형 돌봄 강화', '아이 키우기 좋은 보육 환경 조성'] },
      { icon: 'fas fa-store', title: '경제 · 상생', desc: '동래역·미남역 중심 경제 혁신으로 활력 넘치는 동래를 만듭니다', details: ['동래역 문화 복합 스테이션 조성', '미남역 청년 창업의 메카 조성', '소상공인 상생 경제 기반 마련', '전통시장 활성화 및 지원 확대'] },
      { icon: 'fas fa-laptop-code', title: '미래 · 안전', desc: 'AI 지능형 관제와 친환경 인프라로 365일 안전한 동래', details: ['AI 지능형 관제 시스템 구축', '온천천 안전 그랩바 설치', '시민 햇빛 발전소 조성', '온천천 워터프런트 개발'] },
      { icon: 'fas fa-graduation-cap', title: '교육 · 문화', desc: '글로벌 교육과 동래읍성 역사문화 도시로 도약합니다', details: ['호주·프랑스 연계 글로벌 리더십 캠프', '현대판 향교 교육 프로그램', '동래읍성 빛의 성곽 미디어아트', '글로벌 커피·차 축제 개최'] },
      { icon: 'fas fa-comments', title: '소통 · 행정', desc: '불통과 낡은 관행을 타파하는 열린 행정', details: ['구청장 직통 소통 핫라인 개설', '찾아가는 현장 구청장실 운영', '주민참여 예산제 확대', '투명한 행정 정보 공개'] },
    ],
    contacts: [
  ...
  yhg: {
    pledges: [
      { icon: 'fas fa-user-graduate', title: '충북형 청년 정착 프로젝트', desc: '청년이 떠나지 않는 충북, 돌아오는 충북', details: ['반도체·바이오·이차전지 양질의 일자리 확대', '신혼부부 구옥 구입·리모델링 지원', '산업단지 인근 청년 공공임대주택 확대', '생애주기 맞춤형 육아 정책 추진'] },
      { icon: 'fas fa-shield-alt', title: '안전 충북', desc: '예방 중심 안전 행정으로 전환', details: ['사고 예방 중심 안전 행정 체계 구축', '체험형 안전교육 충북 전역 확대', '현장 중심 재난 대응 역량 강화', '도민 체감형 생활 안전 인프라 확충'] },
      { icon: 'fas fa-microchip', title: '첨단산업 미래 성장동력', desc: '반도체·바이오·AI 중심 산업 구조 혁신', details: ['충북형 메가클러스터 조성', '바이오헬스·반도체·2차전지 산업 확장', '스타필드급 대형 투자 유치·상생 구조', '고부가가치 일자리 창출 전략'] },
      { icon: 'fas fa-balance-scale', title: '북부·중부·남부 균형발전', desc: '충북 전역이 골고루 성장하는 균형 도정', details: ['북부권 관광·헬스·친환경 에너지 육성', '남부권 농식품·와인 산업 창업 거점', '충청권 광역경제협력 주도', '교통·산업·국책사업 공동 대응'] },
      { icon: 'fas fa-handshake', title: '상생하는 지역경제', desc: '대형 투자와 지역 소상공인이 함께 성장', details: ['광역교통 대개편으로 접근성 강화', '소상공인 상생협약 제도화', '지역 농민 판로 확대 지원', '청년 고용 기반 강화'] },
    ],
    contacts: [
      { type: 'phone', label: '전화', value: '043-000-0000' },
      { type: 'address', label: '선거사무소', value: '충북 청주시 (상세 주소 입력)' },
      { type: 'address', label: '소속', value: '국민의힘 충북도지사 후보' },
    ],
    videos: [],
  },
  ...
  edubusan: {
    pledges: [
      { icon: 'fas fa-heart', title: '부산형 늘봄학교 완성 (C-돌봄)', desc: '학교가 교육과 돌봄을 함께 수행하는 완벽한 공간', details: ['거점형 늘봄센터 확대 설치', '방과후 돌봄 프로그램 다양화', '가정의 돌봄 부담 완전 해소', '지역사회 연계 돌봄 네트워크 구축'] },
      { icon: 'fas fa-hands-helping', title: '교권 회복과 행정 업무 경감 (H-희망)', desc: '교사가 수업에만 전념할 수 있는 환경', details: ['학교 행정 지원 본부 설립', '교사 행정 업무 획기적 경감', '학습권과 교권이 공존하는 학교문화', '교육공동체 상호 존중 문화 확산'] },
      { icon: 'fas fa-robot', title: 'AI 기반 기초학력 보장 (A-역량)', desc: '빅데이터와 AI로 한 아이도 포기하지 않는 교육', details: ['BEST(부산형 학업성취도평가) 고도화', 'BASS(AI 맞춤형 학습 시스템) 확대', '부산형 인터넷 강의로 사교육비 경감', '카페형 자기주도학습실 확충'] },
      { icon: 'fas fa-laptop-code', title: '미래형 교육 시스템 구축 (N-미래)', desc: '디지털 대전환 시대의 인재 양성', details: ['디지털 교재 보급 확대', 'AI 소프트웨어 교육 인프라 확충', '아침 체인지(體仁智) 프로젝트 정례화', '인체공학 맞춤형 책걸상 단계적 보급'] },
      { icon: 'fas fa-globe', title: '글로벌 인재 양성 (G-성장)', desc: '세계로 나아가는 부산의 미래 인재', details: ['특성화고 창업 인큐베이터 설립', '가덕도 신공항 연계 항공고 신설 추진', 'K-POP고·해군부사관고 등 직업계고 개편', '세계 시민 교육 프로그램 강화'] },
      { icon: 'fas fa-book-open', title: '교육의 본질 회복 (E-본질)', desc: '정치 논리를 배제하고 아이들만 바라보는 교육', details: ['상식과 원칙이 통하는 학교 현장', '학부모 소통 콘서트 정기 개최', '위탁 급식 특별 안전 관리제 도입', '정책 지속성·일관성 확보'] },
    ],
    contacts: [
      { type: 'phone', label: '전화', value: '051-000-0000' },
  ...
  lhy: {
    pledges: [
      { icon: 'fas fa-city', title: '지역경제 활성화', desc: '기업 경영 경험을 살린 지역경제 발전', details: ['소상공인·자영업자 지원 확대', '청년 창업 생태계 조성', '지역 일자리 창출 기반 마련', '전통시장 현대화 지원'] },
      { icon: 'fas fa-hand-holding-heart', title: '복지·돌봄 강화', desc: '누구도 소외되지 않는 부산', details: ['어르신 돌봄 서비스 확대', '아이 키우기 좋은 환경 조성', '취약계층 맞춤형 복지 강화', '장애인 이동권·자립 지원'] },
      { icon: 'fas fa-bus', title: '교통·생활환경 개선', desc: '편리하고 쾌적한 생활 인프라', details: ['대중교통 노선 확충', '보행 환경 및 도로 정비', '공원·녹지 공간 확대', '주거환경 개선 사업 추진'] },
      { icon: 'fas fa-users', title: '소통하는 시정', desc: '시민이 주인인 열린 의정활동', details: ['주민 의견 청취 정례화', '투명한 의정활동 공개', '현장 중심 민원 해결', '주민참여 예산 확대'] },
      { icon: 'fas fa-shield-alt', title: '안전한 부산', desc: '시민이 안심하는 안전 도시', details: ['CCTV 및 안전 인프라 강화', '재난 대응 체계 구축', '학교 주변 안전 강화', '야간 안심 귀가 환경 조성'] },
    ],
    contacts: [
...
const allIntro = {
  ...
  kma: { subtitle: '33년 교육 현장의 경험, 세종교육의 미래', text: '아이들이 학교에서 자신의 미래를 발견하고, 교실이 진정한 배움과 성장의 공간이 되도록.\n구호가 아닌 설계의 교육, 현장에서 답을 찾겠습니다.' },
  jsh: { subtitle: '똑!순희 주순희, 동래는 주순희입니다', text: '동래구의회 의장으로서 쌓은 행정 경험과\n교육학 박사과정의 전문성을 바탕으로\n사람이 모이고 활력이 넘치는 동래를 만들겠습니다.' },
  edubusan: { subtitle: '9급 공무원에서 교육감까지, 35년 교육 외길', text: '교육은 정치나 이념의 도구가 되어서는 안 됩니다.\n정책은 교실에서 실제로 작동해야 합니다.\n9급 공무원으로 시작해 35년, 오직 아이들만 바라보는 교육을 하겠습니다.' },
  lhy: { subtitle: '경영인에서 정치인으로, 부산을 위한 새 도전', text: '기업을 경영한 경험으로 부산 시정에 새바람을 불어넣겠습니다.\n시민의 목소리를 경청하는 일꾼이 되겠습니다.' },
};
...
const allEducation = {
  ...
  kma: [
    { title: '전주교육대학교 (학사)' },
    { title: '원광대학교 교육대학원 (영어교육 석사)' },
    { title: '고려대학교 행정전문대학원 (정책학 박사과정)' },
    { title: 'KAIST 문술미래전략대학원 (국가미래전략 고위과정)' },
  ],
  jsh: [
    { title: '순천향대학교 대학원 교육과학과 박사과정 수료' },
  ],
  edubusan: [
    { title: '진주중안국민학교' },
    { title: '진주중앙중학교' },
    { title: '경남 송계고등학교' },
    { title: '한국방송통신대학교 행정학과' },
    { title: '고려대학교 대학원 교육학 석사' },
  ],
  lhy: [],
};
...
const allCareer = {
  ...
  kma: [
    { title: '초등학교 교사 (1988~)' },
    { title: '장학사 (임실교육청·전라북도교육청)' },
    { title: '교감 (전주삼천남초·전주아중초·전주인후초)' },
    { title: '교장 (대강초·종촌초·세종도원초)' },
    { title: '세종교원단체총연합회 회장 · 한국교총 이사' },
    { title: '세종미래교육연구소 대표', isCurrent: true },
  ],
  jsh: [
    { title: '제7대 동래구의회 의원 · 기획총무위원장' },
    { title: '제8대 동래구의회 의원 · 후반기 의장' },
    { title: '더불어민주당 정책위원회 부의장' },
    { title: '더불어민주당 부산시당 여성위원장' },
    { title: '더불어민주당 전국여성위원회 부위원장' },
    { title: '더불어민주당 중앙당 부대변인 · 중앙위원', isCurrent: true },
  ],
  yhg: [
    { title: '충북 제천경찰서장' },
    { title: '서울 수서경찰서장' },
    ...
    { title: '서울경찰청 정보관리부장' },
    { title: '경찰청 차장 (치안정감)' },
    { title: '제23대 경찰청장 (2022.8~2024.8)' },
    { title: '청주대학교 경찰행정학과 석좌교수', isCurrent: true },
  ],
  edubusan: [
    { title: '경남도교육청 9급 공채 입직 (1989)' },
    { title: '교육부 평생학습정책과장' },
    { title: '교육부 학교정책과장' },
    { title: '교육부 운영지원과장' },
    { title: '순천대·부경대·부산대 사무국장' },
    { title: '부산광역시교육청 부교육감 (2022.10)' },
    { title: '부산교육감 권한대행 (2024.12~)', isCurrent: true },
  ],
  lhy: [
    { title: '주식회사 미디엄 대표이사', isCurrent: true },
  ],
};
