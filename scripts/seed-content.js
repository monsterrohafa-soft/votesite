...
const candidateData = {
  ...
  cyh: {
    pledges: [
      { icon: 'fas fa-heart', title: '올바른 품성 인성교육', desc: '가정·학교·지역이 함께하는 인성교육', details: ['학부모·지역사회 협력 인성교육 확대', '향교·종교시설 연계 체험형 인성 프로그램', '학습권과 교권을 중시하는 학교문화 정착', '교육공동체 상호 존중 문화 확산'] },
      { icon: 'fas fa-robot', title: 'AI시대 미래역량 교육', desc: '미래를 준비하는 교육 혁신', details: ['인공지능(AI) 교육 전면 강화', '부산형 인터넷 강의 플랫폼 구축', '늘봄학교 내실화 운영', '기초학력 보장 및 학력 격차 해소'] },
      { icon: 'fas fa-shield-alt', title: '안전하고 건강한 안심교육', desc: '학생 안전과 건강을 최우선으로', details: ['특수학교 통학 30분 실현', '인체공학 맞춤형 교실 책걸상 도입', '별빛도서관(야간 개방 도서관) 운영', '학교 안전 인프라 전면 확충'] },
      { icon: 'fas fa-hands-helping', title: '모두에게 힘이 되는 교육복지', desc: '교육 기회의 평등한 보장', details: ['저소득층 학생 인성·영수 캠프 운영', '위캔두 계절학교로 사교육비 경감', '지역 간 교육 격차 해소', '제2행정지원본부 설립으로 교사 업무 경감'] },
      { icon: 'fas fa-comments', title: '소통하고 공감하는 감동교육', desc: '현장의 목소리를 듣는 교육행정', details: ['학부모 소통 콘서트 정기 개최', '가덕도 신공항 연계 항공고 신설 추진', 'K-POP고·해군부사관고 등 직업계고 개편', '정책 지속성·일관성 확보'] },
    ],
    contacts: [
      { type: 'phone', label: '전화', value: '051-000-0000' },
...
const allIntro = {
  ...
  cyh: { subtitle: '9급 공무원에서 교육감까지, 35년 교육 외길', text: '1989년 9급 공무원으로 시작해 35년간 초·중등 교육정책만 담당했습니다.\n교육은 정치가 아닌 전문가가 해야 합니다.' },
