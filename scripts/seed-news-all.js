...
const allNews = {
  ...
  jhh: [
    ...
    { title: '전현희 "서울버스 준공영제 전면 개편…적자 구조 바꾸겠다"', source: '아주경제', url: 'https://www.ajunews.com/view/20260226100000000', date: '2026-02-26' },
  ...
  edubusan: [
    ...
    { title: '부산교육감 재선거 토론회, 보수 정승윤·최윤홍 기싸움', source: '뉴시스', url: 'https://www.newsis.com/view/NISX20250325_0003112917', date: '2025-03-25' },
    { title: '최윤홍 부산교육감 후보, 부산 교육의 미래 비전 제시...첫 거리 유세', source: '겟뉴스', url: 'https://www.getnews.co.kr/news/articleView.html?idxno=812307', date: '2025-03-20' },
  ],
};
